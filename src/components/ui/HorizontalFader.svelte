<script lang="ts">
  ...
  // Convert linear RMS (0–1) to a log-scaled display value (0–1).
  // Floor at –40 dBFS so silence = 0, and a loud voice at –6 dBFS shows ~85%.
  // Scaled by 1.5 so a hot signal overflows into the red (clipping indicator).
